              ...
              return (
                ...
                >
                  ...
                  <CardFooter>
                    ...
                    >
                      <Link href={`/events/${event.slug}`}>{t("eventList.buttonViewDetails")}</Link>
                    </Button>
                  </CardFooter>
                </Card>
              );
